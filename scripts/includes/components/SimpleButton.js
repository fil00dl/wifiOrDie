(function () {
    ...
    window.userInterface = window.userInterface || {};
    ...
    p.drawButton = function(){
        ...
        this.labelTxt = new createjs.Text(this.label,this.fontSize + 'px Arial',this.side);
    ...
    p.setColor = function(color){
        this.side = this.labelTxt.side = color;
    }
    ...
    window.userInterface.SimpleButton = SimpleButton;
}());
